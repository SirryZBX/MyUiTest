...
_241_FIELDS = ('Metadata-Version', 'Name', 'Version', 'Platform',
               'Summary', 'Description',
               'Keywords', 'Home-pages', 'Author', 'Author-email',
               'License')
...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def todict(self, skip_missing=False):
        ...
        instead of hyphen-mixed case (i.e. home_page instead of Home-pages).
...
class Metadata(object):
    ...
    LEGACY_MAPPING = {
        ...
        ('extensions', 'python.project', 'project_urls', 'Home'): 'Home-pages',
